...
from PyQt5.QtWidgets import QApplication, QWidget, QGroupBox, QTreeView, QHBoxLayout, QVBoxLayout
import sys
...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.addMail2(model, 'service@phone.com', 'Your Phone Bill', '01/01/2017 04:05 PM')
